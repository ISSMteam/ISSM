...
extern "C" void run_semic_transient_(int *nx, int *ntime, int *nloop, 
			...
			IssmDouble *tsurf_out, IssmDouble *smb_out, IssmDouble *smbi_out, IssmDouble *smbs_out, IssmDouble *saccu_out, IssmDouble *smelt_out, IssmDouble *refr_out, IssmDouble *albedo_out, IssmDouble *albedo_snow_out, IssmDouble *hsnow_out, IssmDouble *hice_out, IssmDouble *qmr_out, IssmDouble *runoff_out);
#endif
// _HAVE_SEMIC_
/*}}}*/
...
void       Element::SmbSemicTransient(){/*{{{*/
	...
	run_semic_transient_(&nx, &ntime, &nloop,
			...
			tsurf_out, smb_out, smbi_out, smbs_out, saccu_out, smelt_out, refr_out, albedo_out, albedo_snow_out, hsnow_out, hice_out, qmr_out, runoff_out);
