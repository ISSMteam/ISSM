...
int  StringToEnumx(const char* name,bool notfounderror){
   ...
   if(stage==8){
	      if (strcmp(name,"StrOld")==0) return StrOldEnum;
   ...
   if(stage==10){
	      if (strcmp(name,"SealevelchangeAzimuthIndexHydro")==0) return SealevelchangeAzimuthIndexHydroEnum;
   ...
   if(stage==32){
	      if (strcmp(name,"IntrusionMelt")==0) return IntrusionMeltEnum;
