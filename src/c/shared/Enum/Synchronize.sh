...
cat temp |  awk '{print substr($1,1,length($1)-4)}' | awk '/InputsSTART/,/InputsEND/' | grep -v "Inputs" | grep -v "Outputdefinition" | awk {'print "%" $1'}>> $ISSM_DIR/src/m/solve/listoutputs.m
