/* file:  PddSurfaceMassBlanceFast.cpp
   Calculating the surface mass balance using the adapted PDD routine from SICOPOLIS, modified by Alicia
	by borrowing code from Lev's original PDD calculation
 */
...
IssmDouble PddSurfaceMassBalanceFast(IssmDouble* monthlytemperatures, IssmDouble* monthlyprec,
