/*! \file HydrologyPrescribeAnalysis.h 
 *  \brief: header file for generic external result object
 */

#ifndef _HydrologyPrescribeAnalysis_
#define _HydrologyPrescribeAnalysis_

/*Headers*/
#include "./Analysis.h"

class HydrologyPrescribeAnalysis: public Analysis{
