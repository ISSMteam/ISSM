...
%FGMRESBJACOBIOPTIONS - PETSc solver options using the flexible GMRES (fgmres) Krylov method with block Jacobi preconditioning
%
%   Usage:
%      solverOptions=fgmresbjacobioptions(varargin);
