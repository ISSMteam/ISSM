...
%FGMRESPBJACOBIOPTIONS - PETSc solver options using the flexible GMRES (fgmres) Krylov method with point-block Jacobi preconditioning
%
%   Usage:
%      solverOptions=fgmrespbjacobioptions(varargin);
