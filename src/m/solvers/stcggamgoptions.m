...
%STCGGAMGOPTIONS - return PETSc options for the STCG solver with a GAMG (Geometric Algebraic Multigrid) preconditioner
%
%   Usage:
%      solverOptions=stcggamgoptions(varargin);
