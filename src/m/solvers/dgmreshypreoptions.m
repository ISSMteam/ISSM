...
%DGMRESHYPREOPTIONS - PETSc solver options using the deflated GMRES (dgmres) Krylov method with Hypre preconditioning
%
%   Usage:
%      solverOptions=dgmreshypreoptions(varargin);
