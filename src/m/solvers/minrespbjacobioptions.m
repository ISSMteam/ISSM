...
%MINRESPBJACOBIOPTIONS - return PETSc options for the MINRES (minimum residual) Krylov solver with a point-block Jacobi preconditioner
%
%   Usage:
%      solverOptions=minrespbjacobioptions();
