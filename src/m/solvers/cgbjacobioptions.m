...
%CGBJACOBIOPTIONS - define PETSc solver options for the Conjugate Gradient (CG) Krylov method with Block Jacobi preconditioning
%
%   Usage:
%      solverOptions=cgbjacobioptions(varargin);
