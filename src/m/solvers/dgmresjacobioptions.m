...
%DGMRESJACOBIOPTIONS - PETSc solver options using the deflated GMRES (dgmres) Krylov method with Jacobi preconditioning
%
%   Usage:
%      solverOptions=dgmresjacobioptions(varargin);
