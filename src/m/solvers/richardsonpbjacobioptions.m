...
%RICHARDSONPBJACOBIOPTIONS - return PETSc options for the Richardson iteration Krylov solver with a point-block Jacobi preconditioner
%
%   Usage:
%      solverOptions=richardsonpbjacobioptions();
