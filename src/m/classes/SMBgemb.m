...
classdef SMBgemb
	...
	methods
		...
		function disp(self) % {{{
			...
			fielddisplay(self,'ismappingusingneighbors','set to true if forcing when ismappedforcing is true, forcing should be interpolated instead of using mappedforcingpoint value (default false)');
			...
			fielddisplay(self,'lat_mappedforcing','The latitude coordinate of each mapped forcing location (m) for ismappedforcing option. Size number of forcing points.');
			fielddisplay(self,'lon_mappedforcing','The longitude coordinate of each mapped forcing location (m) for ismappedforcing option. Size number of forcing points.');
