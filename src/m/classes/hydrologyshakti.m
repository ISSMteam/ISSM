...
classdef hydrologyshakti
	...
	methods
		...
		function disp(self) % {{{
			...
			fielddisplay(self,'isbasalforcing','use basal forcing from 0) analytical form in Sommers et al. (2018) or 1) md.basalforcings.groundedice_melting_rate. 0 and 1 are available (default: 0)');
