...
md.esa.requested_outputs = {'EsaUmotion','EsaXmotion','EsaYmotion',...
	'EsaStrainratexx','EsaStrainratexy','EsaStrainrateyy','EsaRotationrate','EsaGravitationalAcceleration'};
...
field_names     ={'EsaUmotion','EsaXmotion','EsaYmotion',...
	'EsaStrainratexx','EsaStrainratexy','EsaStrainrateyy','EsaRotationrate','EsaGravitationalAcceleration'};
field_tolerances={1e-13,2e-12,2e-12,9e-12,8e-12,8e-12,3e-11,3e-11};
field_values={...
