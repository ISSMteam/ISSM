...
# 			fi
		...
		*mingw*)
			...
			export OSLIBS="-Wl,-L/c/msys64/mingw64/lib -Wl,-lstdc++ -Wl,-lmingw32 -Wl,-lmingwex -Wl,-lgcc_s -Wl,-lmoldname -Wl,-lm -Wl,-lpthread -Wl,-lshell32 -Wl,-luser32 -Wl,-lgdi32 -Wl,-ladvapi32 -Wl,-lkernel32 -Wl,-lgcc"
		;;
		*)
